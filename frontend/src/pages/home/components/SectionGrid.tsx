    ...
    <div className="mb-8 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {songs.map((song) => (
          <div
            key={song._id}
            className="bg-zinc-800/40 p-4 rounded-[0.5rem] hover:bg-zinc-700/40 transition-all group cursor-pointer"
          >
            <div className="relative mb-4">
              <div className="aspect-square rounded-[0.5rem] shadow-lg overflow-hidden">
                <img
                  src={song.imageUrl}
                  alt={song.title}
